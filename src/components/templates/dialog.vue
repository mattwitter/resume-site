<template>
  <v-dialog v-model="dialog" max-width="300px" max-height="500px" persistent hide-overlay>
    <div class="windows-explorer" ref="explorerDialog" style="width: 850px; height: 1100px;">
      ...
      <v-card-text class="windows-explorer-content">
        ...
        <iframe style="height: 90%;" src="https://mwitter-resume-pdf.s3.amazonaws.com/Matthew_Witter_-_Full_Stack_Developer.pdf" class="pdf-viewer"></iframe>
      </div>
      </v-card-text>
    </div>
  </v-dialog>
